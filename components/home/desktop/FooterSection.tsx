        ...
        <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-7">
              ...
              >
                <h4 className="text-white font-semibold text-sm sm:text-base mb-2">{t("footerCta.title")}</h4>
                <p className="text-slate-400 text-xs sm:text-sm mb-3 sm:mb-4">{t("footerCta.description")}</p>
                <Link
                  href="/lien-he"
