...
const TikTokCard = ({
    ...
    <div className="flex flex-col items-center">
                        ...
                        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-10">
                            <div className="px-3 py-1.5 rounded-full bg-gradient-to-r from-orange-500 to-red-500 shadow-lg">
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-white font-bold text-xs">{followerCount}</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div className="mt-5 text-center max-w-[240px]">
            ...
            <p className="text-orange-400 text-xs font-medium">{followerCount} followers • {likeCount} likes</p>
        </div>
    </div>
);
