                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <div className="inline-block px-4 py-1.5 rounded-full border border-pink-500/30 bg-pink-500/10 text-pink-400 font-bold mb-6 backdrop-blur-md animate-pulse">
                            GIẢI PHÁP TIKTOK SHOP TOÀN DIỆN
                        </div>
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                            Xây Dựng <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-pink-500">TikTok Shop</span> <br />
                            Nghìn Đơn Cùng <span className="text-white">ASI Everest</span>
                        </h1>
                        <p className="text-xl text-slate-300 mb-8 leading-relaxed">
                            Biến kênh TikTok thành cỗ máy bán hàng tự động 24/7.
                            Tiếp cận hàng triệu khách hàng trẻ tiềm năng.
                            <strong> Uy tín - Nhanh chóng - Bền vững.</strong>
                        </p>
