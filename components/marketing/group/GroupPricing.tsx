...
export default function GroupPricing() {
    ...
    const packages = t.groupPricing.plans;

    // Color schemes for each package (Cyan/Purple theme)
    const colorSchemes = [
        { gradient: 'from-cyan-500 to-blue-500', bg: 'from-cyan-500/5 to-blue-500/5' },
        { gradient: 'from-blue-500 to-purple-500', bg: 'from-blue-500/5 to-purple-500/5' },
        { gradient: 'from-purple-500 to-pink-500', bg: 'from-purple-500/5 to-pink-500/5' },
        { gradient: 'from-violet-500 to-purple-500', bg: 'from-violet-500/5 to-purple-500/5' },
    ];
        ...
        <section className="relative py-16 sm:py-24 bg-slate-950 overflow-hidden">
            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    >
                        <span className="text-white">{t.groupPricing.title} </span>
                        ...
                        >
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="relative w-full flex items-center justify-center gap-2 py-3 text-base font-medium text-cyan-400 hover:text-cyan-300 transition-colors mb-4 rounded-lg bg-slate-800/50 hover:bg-slate-800 border border-slate-700/50"
                                >
                                    {expandedCards[`package-${index}`] ? (
                                        <>
                                            {pkg.collapseButton}
