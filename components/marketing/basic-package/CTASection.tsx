...
export default function CTASection() {
    ...
    return (
        <section className="py-16 sm:py-20 relative overflow-hidden bg-gradient-to-r from-orange-600 to-red-600">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                        <a
                            ...
                            className="group flex items-center gap-3 px-8 py-4 bg-white text-orange-600 font-bold text-lg rounded-xl hover:bg-yellow-50 transition-all shadow-xl hover:shadow-2xl"
                        >
