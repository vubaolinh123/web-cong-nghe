            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-white mb-4">
                        {t.overview.title}{" "}
                        <span className="text-orange-400">{t.overview.titleHighlight}</span>
                    </h2>
                </motion.div>
                    ...
                    {t.overview.services.map((service, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="p-4 sm:p-6 rounded-2xl bg-slate-800/50 border border-slate-700 hover:border-orange-500/50 transition-all group"
                            >
                                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
