...
const colors = ["from-cyan-400 to-blue-500", "from-green-400 to-emerald-500", "from-purple-400 to-pink-500"];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-white mb-4">
                        {t.kpiResults.title}{" "}
                        <span className="text-cyan-400">{t.kpiResults.titleHighlight}</span>
                    </h2>
                </motion.div>
                    ...
                    {t.kpiResults.results.map((result, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="p-6 sm:p-8 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-cyan-500/30 transition-all text-center group"
                            >
