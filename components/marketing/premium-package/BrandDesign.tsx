                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white">
                            {t.brand.title}{" "}
                            <span className="text-purple-400">{t.brand.titleHighlight}</span>
                        </h2>
                        <p className="text-slate-400 text-lg">
                            {t.brand.description}
                        </p>
                        <div className="space-y-3">
                            {t.brand.features.map((feature, index) => (
                    ...
                    >
                        <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-pink-500/20 blur-[60px]" />
                        <img
                            src="/image/basic_brand.png"
                            alt="Brand Design"
