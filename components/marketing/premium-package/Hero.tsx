    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center bg-slate-950 overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                <div className="absolute inset-0 bg-gradient-to-br from-cyan-600/20 via-slate-950 to-blue-600/20" />
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24 pb-16">
                ...
                >
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-500/30">
                        ...
                        <span className="text-sm font-bold text-cyan-400">{t.hero.badge}</span>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="text-4xl sm:text-5xl md:text-6xl font-black bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                        <a
                            href="/lien-he"
                            className="group w-full sm:w-auto px-8 py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-bold text-lg transition-all shadow-[0_0_25px_rgba(6,182,212,0.4)] hover:shadow-[0_0_35px_rgba(6,182,212,0.6)] transform hover:-translate-y-1 flex items-center justify-center gap-2"
                        >
                            {t.hero.ctaPrimary}
                        ...
                        <a
                            ...
                            className="w-full sm:w-auto px-8 py-4 rounded-xl border border-cyan-500/40 bg-cyan-500/10 text-cyan-400 font-bold text-lg transition-all hover:bg-cyan-500/20 flex items-center justify-center gap-2"
                        >
